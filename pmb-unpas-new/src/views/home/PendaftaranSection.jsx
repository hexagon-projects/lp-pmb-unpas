                                ...
                                <SwiperSlide key={index}>
                                    <div className="rounded-xl md:rounded-2xl lg:rounded-4xl pb-5">
                                        <img
                                            ...
                                            src={item.image}
                                            alt="Section"
                                            className="w-full h-[40vh] object-cover rounded-xl md:rounded-2xl lg:rounded-4xl"
                                        />
                                    </div>
                                </SwiperSlide>
                            ))}
                                ...
                                <div className="w-full h-full flex flex-row justify-around md:justify-between items-center gap-4">
                                    ...
                                    <div className="w-fit lg:w-1/2">
                                        <div className="w-full flex justify-end">
                                            <Button rounded={'rounded-xl md:rounded-2xl lg:rounded-2xl'} hoverBgColor={'hover:border-3 hover:border-white/50'} text={'Daftar Sekarang'} bgColor="bg-primary" hoverColor={''} onClick={() => (handleClick(jalur.link))} padding="p-4" />
                                        </div>
                                    </div>
                                </div>
                            </motion.div>
