...
const PrestasiCard = ({ title, image, widthImg = 'w-1/2 md:w-[40%]', widthText = 'w-1/2 md:w-[60%]' }) => {
    ...
    return (
        <div className="relative w-full">
            <div className="w-full lg:h-[32vh] flex justify-center items-stretch gap-4 bg-white p-4 rounded-xl md:rounded-2xl lg:rounded-4xl shadow-black/5 shadow-xl drop-shadow-[0px_20px_40px_rgba(254, 242, 81, 0.5)] 
