      ...
      <div className="p-4 md:p-6 lg:p-12 space-y-8 md:space-y-12 lg:space-y-16">
        ...
        >
          ...
          <div className="relative space-y-3 md:space-y-4 z-10 text-center">
            <Text text={"Contact"} sizeText="text-sm md:text-base lg:text-[24px]" color="text-black" />
            <Title
        ...
        <div className="w-full flex flex-col md:flex-row gap-6 md:gap-8 bg-primary rounded-xl md:rounded-2xl lg:rounded-4xl p-4 md:p-8">
