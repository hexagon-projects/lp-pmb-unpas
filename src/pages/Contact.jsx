    ...
    >
      ...
      <div className="p-4 md:p-6 lg:p-12 space-y-8 md:space-y-12 lg:space-y-16">
        ...
        <div className="w-full flex justify-center items-center">
          <div className="w-full md:max-w-4xl lg:max-w-6xl flex flex-col md:flex-row gap-6 md:gap-8 bg-primary rounded-xl md:rounded-2xl lg:rounded-4xl p-4 md:p-8">
