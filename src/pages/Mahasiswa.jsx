  ...
  const renderVideoModal = () => (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <div className="relative border-2 border-white rounded-xl md:rounded-2xl lg:rounded-4xl shadow-lg w-[90%] md:w-[70%] lg:w-[50%]">
            <button
              onClick={() => setIsOpen(false)}
              className="absolute -top-3 -right-3 bg-red-500 text-white p-2 rounded-full cursor-pointer hover:bg-red-700"
            >
              <X size={20} />
            </button>
            <iframe
            ...
            >
              ...
              <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                <div className="w-full md:w-[50%]">
                  <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold whitespace-none break-words text-gray-500">
                    Mahasiswa & Alumni
                  </h1>
                </div>
                <div className="w-full md:w-[50%]">
