...
const AboutSection = ({ data = {} }) => {
    ...
    return (
        <div className="w-full flex justify-center items-center">
            <div className="w-full md:w-[90%] lg:w-[90%] xl:w-[80%] flex flex-col lg:flex-row-reverse justify-center items-start md:items-center gap-4 md:gap-6 lg:gap-8 mt-0 md:mt-20 p-4">
                {data?.about?.image1 && (
                    <div
