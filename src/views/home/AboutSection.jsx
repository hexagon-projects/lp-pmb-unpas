...
const AboutSection = ({ data = {} }) => {
    ...
    return (
        <div className="w-full flex justify-center items-center">
            <div className="w-full mx-5 md:mx-10 lg:mx-15 flex flex-col lg:flex-row-reverse justify-center items-start md:items-center gap-4 md:gap-6 lg:gap-8 mt-5 md:mt-10">
                {data?.about?.image1 && (
                    <div
