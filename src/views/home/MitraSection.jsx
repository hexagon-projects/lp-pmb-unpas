      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-lg w-11/12 md:w-3/4 lg:w-1/2">
            ...
            <p className="mb-4">{selectedMitra?.description || 'Ini adalah detail mitra kerjasama.'}</p>
            <button onClick={closeModal} className="bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary-dark">
              Tutup
            </button>
          </div>
        </div>
