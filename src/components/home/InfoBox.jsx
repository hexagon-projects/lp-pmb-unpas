...
const InfoBox = () => {
    return (
        <div className="w-full md:w-[90%] lg:w-[90%] xl:w-[80%] hidden justify-center items-center m-8 bg-[#F0F0F0] rounded-lg md:rounded-2xl lg:rounded-4xl">
                    ...
                    >
                        <div className="p-2 md:p-3 bg-gray-100 rounded-full">
                            <div className="text-sm md:text-base lg:text-lg text-text">
                                <img src={item.icon} alt={item.text} aria-hidden="true"/>
                            </div>
                        </div>
