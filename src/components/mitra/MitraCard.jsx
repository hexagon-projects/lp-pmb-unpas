...
const MitraCard = ({ title, image, widthImg = 'w-1/2 md:w-[35%]', widthText = 'w-1/2 md:w-[60%]', onClick, description, linkWeb }) => {
        ...
        <div className="relative w-full h-full cursor-pointer" onClick={onClick}>
            ...
            {/* <div className="w-full h-full flex justify-center place-items-stretch gap-4 bg-white p-4 rounded-lg md:rounded-2xl lg:rounded-4xl shadow-lg drop-shadow-[0px_20px_40px_rgba(254, 242, 81, 0.5)] 
                ...
                <div className={`${widthText} flex flex-col justify-center gap-4 min-h-[150px]`}>
                    ...
                    <div className="px-4 py-2 bg-primary text-black w-fit rounded-lg transition-colors duration-500 hover:bg-primary/70">
