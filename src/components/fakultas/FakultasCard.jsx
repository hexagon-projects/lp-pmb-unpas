    ...
    >
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <img
          ...
          alt={title}
          className={`w-full h-full object-cover transition-all duration-500 ease-in-out ${loaded ? 'opacity-100' : 'opacity-0'} group-hover:scale-105`}
          loading="lazy"
      ...
      <div className="absolute bottom-2 w-full flex items-end justify-between p-4">
        ...
        <div className="bg-white p-2 rounded-xl">
          <ArrowRight size={30} className="text-text transition duration-500 group-hover:-rotate-45" /> 
        </div>
      </div>
    </div>
  )
