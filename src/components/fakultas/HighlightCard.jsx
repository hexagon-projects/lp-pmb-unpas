...
const HighlightCard = ({title, text}) => {
    return (
        <div className="group flex flex-col justify-start items-start text-start rounded-xl md:rounded-2xl lg:rounded-4xl p-4 md:p-6 cursor-pointer bg-white shadow-black/5 shadow-xl drop-shadow-[0px_20px_40px_rgba(254, 242, 81, 0.5)] space-y-3 md:space-y-4 hover:bg-blue-500 transition-all duration-500">
