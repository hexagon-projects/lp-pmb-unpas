...
const Footer = () => {
    ...
    return (
        <footer className="bg-[#034833] text-white p-4 md:p-6 lg:p-8 m-2 md:m-6 lg:m-6 rounded-xl md:rounded-2xl lg:rounded-4xl relative overflow-hidden">
            <div className="absolute -top-0 left-25 md:left-3/5 w-full h-full opacity-50 object-cover">
                <img src={LogoOutline} alt={"Logo Outline Unpas"} loading="lazy" className="h-[70vh] object-cover object-left" />
            </div>
